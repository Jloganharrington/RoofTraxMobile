...
export const PERMISSION_REGISTRY: readonly PermissionEntry[] = [
  ...
  },
  {
    ...
    default: { kind: 'ownerOrRole', minRole: 'manager' },
    note:   'Section 8 ruling (FINDING 3-C reversed): field-rep owners may export their own lead financials.',
  },
  {
    ...
    default: { kind: 'ownerOrRole', minRole: 'manager' },
    note:   'Section 8 ruling (FINDING 3-C reversed): field-rep owners may view their own lead financials.',
  },
  ...
  // ── invoice (6) ──────────────────────────────────────────────────────────────
  {
    ...
    default: { kind: 'ownerOrRole', minRole: 'manager' },
    note:   'Section 8 ruling: field-rep owners may read invoices on their own leads.',
  },
  {
    key:    'invoice.create',
    domain: 'invoice',
    ...
    default: { kind: 'ownerOrRole', minRole: 'manager' },
    note:   'Section 8 ruling: field-rep owners may create invoices on their own leads.',
  },
  {
    key:    'invoice.update',
    domain: 'invoice',
    ...
    default: { kind: 'ownerOrRole', minRole: 'manager' },
    note:   'Section 8 ruling: field-rep owners may edit invoices on their own leads.',
  },
  {
    key:    'invoice.delete',
    domain: 'invoice',
    ...
    default: { kind: 'ownerOrRole', minRole: 'manager' },
    note:   'Section 8 ruling: field-rep owners may delete invoices on their own leads.',
  },
  {
    key:    'invoice.send',
    domain: 'invoice',
    ...
    default: { kind: 'ownerOrRole', minRole: 'manager' },
    note:   'Section 8 ruling: field-rep owners may send invoices on their own leads.',
  },
  {
    key:    'invoice.void',
    domain: 'invoice',
    ...
    default: { kind: 'ownerOrRole', minRole: 'manager' },
    note:   'Section 8 ruling: field-rep owners may void invoices on their own leads.',
  },
