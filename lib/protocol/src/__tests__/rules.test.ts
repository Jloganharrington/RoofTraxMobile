...
function completeState(): InspectionProtocolState {
  return {
    ...
    components: [{ id: 'comp-1', photoCaptured: true }],
...
describe('evaluate (protocol v2)', () => {
  ...
  const SINGLE_DEFICIENCY_FIXTURES: Array<{
    ...
    { name: 'component w/o photo', mutate: (s) => { s.components[0]!.photoCaptured = false; }, stage: 'components', code: 'MISSING_COMPONENT_PHOTO_comp-1' },
