...
- [Permission STEP 3 complete](perm-step3-complete.md) — all 31 domains migrated (115 keys, 997 tests); ownerOrRole middleware must use the READ key as pre-gate; inspection.delete=super_admin; dashboardGuard now calls loadActorCtx.
