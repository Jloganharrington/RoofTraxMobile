...
- [Remediation Step 3 gates](remediation-step3-gates.md) — 3-C profitability gate, 3-F pipelineStage removed, 3-H contractAmount manager-only, 3-I ≤0 rejected; PD-1/2/3 + audit record still blocked on policy rulings.
