...
- [Contract Record system](contract-record-system.md) — migration 036; OpenAPI-first; portalFetch mutator strips /api; rep-assisted select; void clears pin write-back in tx; inspection estimate prefill; all 3 tsc clean.
