...
- `lib/db/src/schema/axiomrestore.ts`: `PAYMENT_TYPES`, `paymentsTable`, `Payment`, `InsertPayment`.
...
- `artifacts/axiomrestore-web/src/pages/leads/LeadProfile.tsx`: `FinancialsTab` rewritten with payments ledger UI using generated hooks.
