...
const BP_LABEL_TO_KEY: Record<string, string> = {
  ...
  'aluminum siding protocol': 'aluminum_siding_protocol',
  'aluminum siding forensic inspection protocol': 'aluminum_siding_protocol',
  ...
  aluminum_siding_protocol: 'aluminum_siding_protocol',
