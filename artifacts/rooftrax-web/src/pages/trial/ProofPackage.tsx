          ...
          <div className="max-w-4xl">
            ...
            <div className="space-y-8">
              {[
                ...
                { q: "Do you work with public adjusters?", a: "No. RoofTrax is built exclusively for contractors." },
                { q: "Is RoofTrax owned by a roofing company?", a: "No — we are an independent software company. The founder has 20 years in insurance restoration, but every customer is an isolated tenant." }
              ].map((faq) => (
