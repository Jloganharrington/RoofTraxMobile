...
export default function PPUpgradePage() {
  ...
  const handleChoosePlan = async (planKey: string) => {
    if (sessionStatus === 'unauthenticated') {
      ...
      window.location.href = `/rooftrax-web/pp/login?returnTo=${encodeURIComponent('/rooftrax-web/pp/upgrade')}`;
      return;
    }
      ...
      <div className="border-b border-zinc-800 bg-zinc-900/50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-white">RoofTrax</span>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 space-y-10">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-zinc-400 text-lg max-w-xl mx-auto">
            Get the complete RoofTrax platform — lead pipelines, team management,
