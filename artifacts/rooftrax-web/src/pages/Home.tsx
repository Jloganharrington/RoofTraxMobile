...
function MarketingNav() {
  ...
  const handleLogin = () => { window.location.href = `/api/login?returnTo=/rooftrax-web/`; };
    ...
    <section className="pt-14 min-h-screen flex flex-col justify-center px-6 md:px-20 py-24">
      <div className="max-w-5xl">
        ...
        <h1 className="text-5xl sm:text-6xl md:text-8xl font-black uppercase leading-none mb-8 tracking-tight">
          <span className="block text-white">RoofTrax turns</span>
      ...
      <div className="max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-0 border border-white/10">
          ...
          <div className="p-8">
            ...
            <div className="text-sm font-semibold text-orange-400 mb-4">RoofTrax</div>
        ...
        <div className="p-10">
          ...
          <ul className="space-y-5">
            {[
              ...
              { icon: BookOpen,  title: "Migration performed for you",        desc: "Your CRM export, price book, document templates, and photo library are loaded by RoofTrax." },
    ...
    <section className="border-t border-white/[0.08] px-6 md:px-20 py-20">
      <div className="max-w-5xl">
        ...
        <h2 className="text-3xl md:text-4xl font-black uppercase text-white mb-4 leading-tight">
          Competitors sell software.<br />RoofTrax sells an operating system with software attached.
        </h2>
    ...
    <footer className="border-t border-white/[0.08] px-6 md:px-20 py-12">
      <div className="max-w-5xl flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
        <div>
          ...
          <p className="text-xs text-zinc-600 max-w-xs leading-relaxed">
            B2B SaaS for storm restoration contractors. RoofTrax is an independent software company.
          </p>
        </div>
      ...
      <div className="max-w-5xl mt-10 pt-6 border-t border-white/[0.04]">
        <p className="text-[10px] text-zinc-700 leading-relaxed max-w-3xl">
          RoofTrax documentation technology is designed to support contractor-lane discipline. RoofTrax does not provide public adjusting services, does not interpret insurance policies, and does not guarantee coverage determinations, carrier payment amounts, or claim approval rates. All proof packages are produced for use by licensed contractors under their own credentials.
        </p>
      </div>
    </footer>
  );
